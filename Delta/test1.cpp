...
double ReadData(int data_set, std::map<std::string, DataAttr*> &data_pool, std::vector<std::pair<std::string, std::set<std::pair<std::string, std::string>>>> &column, std::map<std::pair<std::string, std::string>, int> &data_pairs_pool) {
    ...
    std::string file_name = "../Data/classic_data/data_";
...
int Compute(std::map<std::string, DataAttr*> &data_pool, std::vector<std::pair<std::string, std::set<std::pair<std::string, std::string>>>> &column) {
    ...
    for(auto& block : column) {
        ...
        for(auto& data_pair : block.second) {
            ...
            int dict_first = data_pool[data_pair.first]->m_dict;
            int dict_second = data_pool[data_pair.second]->m_dict;
            assert(dict_first >= 1 && dict_first <= data_pool.size() && (data_pool[data_pair.first]->m_list >= 0));
            assert(dict_second >= 1 && dict_second <= data_pool.size() && (data_pool[data_pair.second]->m_list >= 0));
...
int AssignByPairFreq(std::map<std::string, DataAttr*> &data_pool, std::map<std::pair<std::string, std::string>, int> &data_pairs_pool, std::map<int, std::list<std::string>> &data_lists, std::vector<std::pair<std::string, std::set<std::pair<std::string, std::string>>>> &column) {
